...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {33000000} \
   CONFIG.PHASE {0.000} \
 ] $CLK
  set DATA_8B [ create_bd_port -dir I -from 7 -to 0 DATA_8B ]
  set DIP_SW [ create_bd_port -dir I DIP_SW ]
  set DIP_SW2 [ create_bd_port -dir I DIP_SW2 ]
  ...
  set o_top_vga_blue [ create_bd_port -dir O -from 3 -to 0 o_top_vga_blue ]
  set o_top_vga_green [ create_bd_port -dir O -from 3 -to 0 o_top_vga_green ]
  set o_top_vga_red [ create_bd_port -dir O -from 3 -to 0 o_top_vga_red ]
  ...
  connect_bd_net -net CLK [get_bd_ports CLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rgb565_ctrl_0/CLK]
  connect_bd_net -net DATA_8B_1 [get_bd_ports DATA_8B] [get_bd_pins rgb565_ctrl_0/DATA_IN]
  connect_bd_net -net DIP_SW2_1 [get_bd_ports DIP_SW2] [get_bd_pins sccb_rom_0/DIP_SW2]
  connect_bd_net -net DIP_SW_1 [get_bd_ports DIP_SW] [get_bd_pins sccb_if_0/DIP_SW]
  ...
  connect_bd_net -net clk_wiz_0_CLK_25M [get_bd_pins clk_wiz_0/CLK_25M] [get_bd_pins hdmi_generator_0/CLK_25M] [get_bd_pins sccb_if_0/CLK_25M] [get_bd_pins sccb_rom_0/CLK_25M]
  connect_bd_net -net clk_wiz_0_CLK_50M [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/CLK_50M]
  ...
  connect_bd_net -net hdmi_generator_0_hsync [get_bd_ports hsync] [get_bd_pins hdmi_generator_0/hsync]
  connect_bd_net -net hdmi_generator_0_o_top_vga_blue [get_bd_ports o_top_vga_blue] [get_bd_pins hdmi_generator_0/o_top_vga_blue]
  connect_bd_net -net hdmi_generator_0_o_top_vga_green [get_bd_ports o_top_vga_green] [get_bd_pins hdmi_generator_0/o_top_vga_green]
  connect_bd_net -net hdmi_generator_0_o_top_vga_red [get_bd_ports o_top_vga_red] [get_bd_pins hdmi_generator_0/o_top_vga_red]
  connect_bd_net -net hdmi_generator_0_vsync [get_bd_ports vsync] [get_bd_pins hdmi_generator_0/vsync]
  connect_bd_net -net reset_rtl_1 [get_bd_ports RST] [get_bd_pins hdmi_generator_0/RST] [get_bd_pins rgb565_ctrl_0/RST] [get_bd_pins sccb_if_0/RST] [get_bd_pins sccb_rom_0/RST]
  ...
  connect_bd_net -net sccb_if_0_INIT_DONE [get_bd_ports INIT_DONE_LED] [get_bd_pins sccb_if_0/INIT_DONE_LED]
